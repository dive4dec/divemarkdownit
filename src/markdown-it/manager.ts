 ...
 */
export class MarkdownItManager implements IMarkdown.IMarkdownManager {
   ...
   */
  protected userPluginOptions: IMarkdown.IAllPluginOptions = {};
  ...
  protected onSettingsChanged() {
    ...
    this.userPluginOptions =
      (this.settings?.composite[
        'plugin-options'
      ] as IMarkdown.IAllPluginOptions) || {};
   ...
   */
  addPluginProvider(provider: IMarkdown.IPluginProvider): void {
